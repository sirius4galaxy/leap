   ...
   */
   ...
   class [[eosio::contract("eosio.system")]] system_contract : public native {
      ...
      public:
         ...
         static constexpr eosio::name token_account{SYSTEM_TOKEN_ACCOUNT};
         static constexpr eosio::name ram_account{SYSTEM_RAM_ACCOUNT};
         static constexpr eosio::name ramfee_account{SYSTEM_RAMFEE_ACCOUNT};
         static constexpr eosio::name stake_account{SYSTEM_STAKE_ACCOUNT};
         static constexpr eosio::name bpay_account{SYSTEM_BPAY_ACCOUNT};
         static constexpr eosio::name vpay_account{SYSTEM_VPAY_ACCOUNT};
         static constexpr eosio::name names_account{SYSTEM_NAMES_ACCOUNT};
         static constexpr eosio::name saving_account{SYSTEM_SAVING_ACCOUNT};
         static constexpr eosio::name rex_account{SYSTEM_REX_ACCOUNT};
         static constexpr eosio::name reserve_account{SYSTEM_RESERV_ACCOUNT}; // cspell:disable-line
         static constexpr eosio::name null_account{SYSTEM_NULL_ACCOUNT};
         ...
         static symbol get_core_symbol( name system_account = SYSTEM_ACCOUNT ) {
