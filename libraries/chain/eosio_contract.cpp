 ...
 */
#define IMPL_NATIVE_NEWACCOUNT_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,newaccount) ) )(apply_context& context) {\
   ...
   if( !creator.is_privileged() ) {\
      string privilege_prefix = string(BOOST_STRINGIZE(contract)) + ".";\
      EOS_ASSERT( name_str.find( privilege_prefix ) != 0, action_validate_exception,\
                  "only privileged accounts can have names that start with " + privilege_prefix );\
   }\
   \
...
IMPL_NATIVE_NEWACCOUNT_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_SETCODE_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,setcode) ) )(apply_context& context) {\
...
IMPL_NATIVE_SETCODE_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_SETABI_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,setabi) ) )(apply_context& context) {\
...
IMPL_NATIVE_SETABI_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_UPDATEAUTH_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,updateauth) ) )(apply_context& context) {\
   ...
   string privilege_prefix = string(BOOST_STRINGIZE(contract)) + ".";\
   EOS_ASSERT( update.permission.to_string().find( privilege_prefix ) != 0, action_validate_exception,\
               "Permission names that start with " + privilege_prefix + " are reserved" );\
...
IMPL_NATIVE_UPDATEAUTH_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_DELETEAUTH_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,deleteauth) ) )(apply_context& context) {\
   /*context.require_write_lock( config::eosio_auth_scope );*/\
   \
...
IMPL_NATIVE_DELETEAUTH_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_LINKAUTH_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,linkauth) ) )(apply_context& context) {\
   /*context.require_write_lock( config::eosio_auth_scope );*/\
   \
...
IMPL_NATIVE_LINKAUTH_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_UNLINKAUTH_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,unlinkauth) ) )(apply_context& context) {\
   /* context.require_write_lock( config::eosio_auth_scope );*/\
   \
...
IMPL_NATIVE_UNLINKAUTH_HANDLER(NATIVE_HANDLER_TAG, CTX)

#define IMPL_NATIVE_CANCELDELAY_HANDLER(contract, context) \
   void BOOST_PP_CAT(apply_, BOOST_PP_CAT(contract, BOOST_PP_CAT(_,canceldelay) ) )(apply_context& context) {\
...
IMPL_NATIVE_CANCELDELAY_HANDLER(NATIVE_HANDLER_TAG, CTX)
